    ...
    <div class="py-8 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Deposit Management</h1>
                    <p class="text-gray-600">Review and approve cryptocurrency deposit proof submissions</p>
                </div>
                <div class="flex gap-3">
                    <a href="{{ route('admin.deposits.settings') }}" class="px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold shadow-md transition-all duration-200 text-sm flex items-center">
                        <i class="fas fa-cog mr-2"></i> Configure Addresses
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex justify-between items-center">
                    <div>
                        <p class="text-xs text-gray-500 font-semibold uppercase tracking-wider mb-1">Approved Deposits</p>
                        <h3 class="text-3xl font-bold text-green-600">
                            ${{ number_format(\App\Models\Deposit::where('status', 'approved')->sum('amount'), 2) }}
                        </h3>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex justify-between items-center">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-blue-600">{{ \App\Models\Deposit::count() }}</h3>
                    </div>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-9 w-9 rounded-full bg-blue-100 text-blue-600 font-bold flex items-center justify-center text-sm shadow-sm">
                                            {{ strtoupper(substr($dep->user->name, 0, 1)) }}
                                        </div>
                                        <div class="ml-3">
                                            <div class="text-sm font-semibold text-gray-900">{{ $dep->user->name }}</div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold">
                                    <a href="{{ route('admin.deposits.show', $dep->id) }}" class="text-blue-600 hover:text-blue-900 flex items-center gap-1">
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-sm text-gray-500">
                                    <div class="flex flex-col items-center justify-center space-y-2">
                                        ...
                                        <span>No deposit requests found.</span>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
